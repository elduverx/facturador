  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className={`md:hidden p-3 rounded-2xl border transition-all z-[60] relative overflow-hidden ${
          open
      ...
      {/* Mobile Menu Overlay */}
      <div 
        className={`md:hidden fixed inset-0 bg-[var(--pv-navy)] z-50 flex flex-col justify-center transition-all duration-700 ease-in-out ${
