  ...
  return (
    <div className="min-h-screen bg-[var(--pv-marble)] font-sans">
      ...
      <main className="pb-8 sm:pb-12">
            ...
            {clientType === null && (
              <div className="animate-fade-in flex flex-col items-center justify-center min-h-[60vh]">
                <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-16">
                  ...
                  <p className="text-lg sm:text-2xl text-white/90 leading-relaxed drop-shadow-md px-2 sm:px-0 font-medium">
                    Bienvenido. Por favor, selecciona una opción para continuar.
                  </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 w-full max-w-4xl mx-auto">
                  <button
                    onClick={() => setClientType('new')}
                    className="group flex flex-col items-center text-center transition-all duration-500 p-8 sm:p-12 border-2 border-white/20 bg-white/10 hover:bg-white hover:border-[var(--pv-gold)] rounded-[2rem] shadow-2xl hover:-translate-y-2 backdrop-blur-md"
                  >
                    <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl flex items-center justify-center mb-6 bg-[var(--pv-gold)] text-white shadow-inner group-hover:scale-110 transition-transform duration-500">
                      <Users size={32} className="sm:w-10 sm:h-10" />
                    </div>
                    <h3 className="text-xl sm:text-3xl font-bold mb-3 font-roman uppercase text-white group-hover:text-[var(--pv-navy)] transition-colors">Soy un cliente nuevo</h3>
                    <p className="text-sm sm:text-base text-white/80 group-hover:text-[var(--pv-navy)]/80 transition-colors">
                      Quiero recibir asesoramiento, realizar una consulta o iniciar un trámite con vosotras.
                    </p>
                  </button>
                  <button
                    ...
                    className="group flex flex-col items-center text-center transition-all duration-500 p-8 sm:p-12 border-2 border-white/20 bg-white/10 hover:bg-white hover:border-[var(--pv-gold)] rounded-[2rem] shadow-2xl hover:-translate-y-2 backdrop-blur-md"
                  >
                    <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl flex items-center justify-center mb-6 bg-white/20 text-white shadow-inner group-hover:bg-[var(--pv-navy)] group-hover:scale-110 transition-all duration-500">
                      <ShieldCheck size={32} className="sm:w-10 sm:h-10" />
                    </div>
                    <h3 className="text-xl sm:text-3xl font-bold mb-3 font-roman uppercase text-white group-hover:text-[var(--pv-navy)] transition-colors">Ya soy cliente</h3>
                    <p className="text-sm sm:text-base text-white/80 group-hover:text-[var(--pv-navy)]/80 transition-colors">
                      Quiero acceder a Mi Portal para ver mis expedientes o agendar una cita de seguimiento.
                    </p>
                  </button>
                </div>
              </div>
        ...
        {/* Sections below are only for new clients */}
        {clientType === 'new' && (
          <>
